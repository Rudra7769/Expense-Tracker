  ...
  return (
    <div className="relative mx-auto mt-16 w-[95vw] sm:w-[92vw] md:w-[88vw] lg:w-[84vw] xl:w-[80vw] max-w-none px-0 md:-ml-[5vw] lg:-ml-[7.5vw] xl:-ml-[10vw]">
      ...
      >
        ...
        {/* Laptop shell */}
        <div
          className="relative z-[1] rounded-xl bg-black/60 backdrop-blur supports-[backdrop-filter]:bg-black/40 shadow-[0_0_40px_0_rgba(0,101,248,0.18),0_0_120px_10px_rgba(0,101,248,0.12),0_20px_100px_-20px_rgba(0,0,0,0.7)]"
              ...
              <div className="absolute inset-0 grid grid-cols-12 gap-5 p-6">
                ...
                <div className="col-span-3 rounded-lg bg-white/4 p-4 flex flex-col">
                  ...
                  <div className="space-y-2 text-xs">
                    {["Dashboard", "Invoices", "Messages", "My Wallets", "Activity", "Analytics"].map((label, i) => (
                      <div
                        key={i}
                        className="flex items-center gap-3 py-1 px-2 rounded-md hover:bg-white/5"
                      >
                        <div className="h-4 w-4 rounded-md bg-white/14" />
                        <span className="flex-1">{label}</span>
                        {label === "Messages" && (
                          <span className="inline-flex items-center justify-center text-[10px] h-4 w-4 rounded-full bg-white/20">
                            5
                          </span>
                        )}
                      </div>
                ...
                <div className="col-span-6 flex flex-col">
                  ...
                  <div className="rounded-lg bg-white/5 p-4 flex-1">
                    <div className="flex items-center gap-3 mb-3 text-xs">
                      ...
                      <div className="flex items-center gap-3 ml-4">
                        <span className="inline-flex items-center gap-1">
                          <span className="h-2 w-2 rounded-full bg-[#0065F8] inline-block" />
                          Income
                        </span>
                        <span className="inline-flex items-center gap-1">
                      ...
                      <div className="ml-auto text-[10px] px-2 py-1 rounded bg-white/8">
                        Jan 10 - Jan 16
                      </div>
                    </div>
                    <div className="relative h-full min-h-36 rounded bg-gradient-to-b from-white/3 to-transparent overflow-hidden">
                      ...
                      >
                        <polyline
                          points="0,25 10,28 20,22 30,30 40,18 50,32 60,24 70,34 80,26 90,28 100,22 110,30 120,20"
                          fill="none"
                          stroke="#0065F8"
                          strokeWidth="1.5"
                        />
                        <polyline
                          points="0,30 10,32 20,26 30,34 40,24 50,36 60,28 70,38 80,30 90,32 100,26 110,34 120,26"
                          fill="none"
                ...
                <div className="col-span-3 rounded-lg bg-white/4 p-4 flex flex-col">
                  ...
                  <div
                    ...
                    style={{ background: "linear-gradient(180deg,#0065F8,#0065F)" }}
                  >
                  ...
                  <div className="grid grid-cols-4 gap-2 mb-4 text-[10px] text-center text-white/70">
                    {["Send", "Receive", "Invoicing", "More"].map((t) => (
                      <div
                        key={t}
                        className="rounded-md h-12 bg-[#0065F8]/20 flex flex-col items-center justify-center gap-1"
                      >
